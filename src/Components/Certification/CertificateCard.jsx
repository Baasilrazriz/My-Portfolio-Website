...
function CertificateCard(props) {
    return (
        <a href={props.link} id={props.id}  className="relative w-80 h-48 aspect-auto bg-slate-200 text-center  hover:scale-110 shadow-md rounded-xl  hover:shadow-md hover:shadow-gray-500">
