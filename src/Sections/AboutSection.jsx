...
function AboutSection(props) {
  ...
  return (
    <div
      className=" bg-slate-400 dark:bg-slate-800 overflow-hidden "
      id="about"
    >
              ...
              <div className="sm:flex block sm:mx-5 mx-20   xl:px-10   lg:mr-4 text-nowrap gap-10 ">
                <div>
                  <div className="flex gap-2 ">
                    <h1 className="font-medium text-nowrap text-gray-900 dark:text-white  font-serif  xl:text-2xl lg:text-lg sm:text-xl text-[1.4rem] ">
                      Name :
                    </h1>
                    <p className="pt-1  text-justify  xl:text-xl lg:text-lg  text-[1.4rem] font-serif sm:text-xl text-gray-700 dark:text-gray-400">
                      Muhammad Basil irfan Rizvi
                    </p>
                  </div>

                  <div className="flex gap-2">
                    <h1 className=" font-medium text-gray-900 dark:text-white  font-serif  xl:text-2xl lg:text-lg sm:text-xl text-[1.4rem]">
                      DOB :
                    </h1>
                    <p className="pt-1  text-justify xl:text-xl lg:text-lg text-[1.4rem] font-serif sm:text-xl text-gray-700 dark:text-gray-400">
                      June 30,2003
                  ...
                  <div className="flex gap-2">
                    ...
                    <p className="pt-1  text-justify xl:text-xl  text-[1.4rem] font-serif lg:text-lg sm:text-xl text-gray-700 dark:text-gray-400">
                      M
                    </p>
                  </div>
                </div>
                ...
                <div className=" ">
                  <div className="flex gap-2">
                    ...
                    <p className="pt-1  text-left xl:text-xl  text-[1.4rem] lg:text-lg font-serif sm:text-xl  text-gray-700 dark:text-gray-400">
              ...
              <div>
                <div className="flex items-center mt-20 mb-5 justify-around">
                  <div className=" sm:space-x-7 space-x-3 md:flex-row flex  ">
                    ...
                    <div>
                      <a href="#con">
                        <button className="transition-all delay-175 overflow-hidden h-14 w-48 sm:h-14 sm:w-56 items-center   text-xl rounded-3xl font-bold bg-blue-900 text-gray-100 border-blue-200 border-solid border-2 hover:bg-blue-400 hover:border-1 hover:border-solid hover:border-black  hover:text-slate-950 hover:scale-105 hover:shadow-lg hover:shadow-blue-700">
                          Hire Me
                        </button>
                      </a>
                    </div>
