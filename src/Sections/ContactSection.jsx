            ...
            <div className="text-gray-400 mx-auto max-w-screen-xl px-4 py-20 sm:px-6 lg:px-8 ">
              <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5 md:mx-0 mx-10 ">
                <div className="lg:col-span-2 lg:py-12">
                  <div className="mt-8">
                    <div className="">
                      <div className="flex  py-3 border-2 border-black  rounded-lg bg-gray-800 mb-5 hover:border-green-500 hover:drop-shadow-xl transition-shadow ">
                      ...
                      <div className="flex py-3 border-2 border-black  rounded-lg bg-gray-800 mb-5 hover:border-blue-700 hover:drop-shadow-xl transition-shadow">
                      ...
                      <div className="flex  py-3 border-2 border-black  rounded-lg bg-gray-800 mb-5 hover:border-red-600 hover:drop-shadow-xl transition-shadow">
